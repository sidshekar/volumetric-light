...
void Utils::setVertQuadData(std::vector<VertexFormat>& vertices, std::vector<GLuint>& indices){

	std::vector<VertexFormat> Vertices;
	Vertices.push_back(VertexFormat(Position(-1.0f, -1.0, 0.0), TexCoord(0.0, 1.0), Normals(0.0f, 1.0f, 0.0)));
	Vertices.push_back(VertexFormat(Position(1.0, -1.0, 0.0),	TexCoord(1.0, 1.0), Normals(0.0f, 1.0f, 0.0)));
	Vertices.push_back(VertexFormat(Position(1.0, 1.0, 0.0),	TexCoord(1.0, 0.0), Normals(0.0f, 1.0f, 0.0)));
	Vertices.push_back(VertexFormat(Position(-1.0, 1.0, 0.0),	TexCoord(0.0, 0.0), Normals(0.0f, 1.0f, 0.0)));
...
void Utils::setHorQuadData(std::vector<VertexFormat>& vertices, std::vector<GLuint>& indices){

	std::vector<VertexFormat> Vertices;
	std::vector<GLuint> Indices;

	//top
	Vertices.push_back(VertexFormat(Position(-1.0f, 0.0f, -1.0f), TexCoord(0.0, 1.0), Normals(0.0f, 1.0f, 0.0)));
	Vertices.push_back(VertexFormat(Position(1.0f, 0.0f, -1.0f), TexCoord(1.0, 1.0), Normals(0.0f, 1.0f, 0.0)));
	Vertices.push_back(VertexFormat(Position(1.0f, 0.0f, 1.0f), TexCoord(1.0, 0.0), Normals(0.0f, 1.0f, 0.0)));
	Vertices.push_back(VertexFormat(Position(-1.0f, 0.0f, 1.0f), TexCoord(0.0, 0.0), Normals(0.0f, 1.0f, 0.0)));
...
void Utils::setPyramidData(std::vector<VertexFormat>& vertices, std::vector<GLuint>& indices){
	...
	Vertices.push_back(VertexFormat(Position(0.0f, 1.0, 0.0), TexCoord(1.0, 1.0), Normals(0.0f, -1.0f, 0.0))); // 0

	//bottom
	Vertices.push_back(VertexFormat(Position(-1.0f, -1.0, -1.0), TexCoord(1.0, 1.0), Normals(0.0f, -1.0f, 0.0))); //1
	Vertices.push_back(VertexFormat(Position(1.0, -1.0, -1.0), TexCoord(0.0, 1.0), Normals(0.0f, -1.0f, 0.0)));   //2
	Vertices.push_back(VertexFormat(Position(1.0, -1.0, 1.0), TexCoord(0.0, 0.0), Normals(0.0f, -1.0f, 0.0)));    //3
	Vertices.push_back(VertexFormat(Position(-1.0, -1.0, 1.0), TexCoord(1.0, 0.0), Normals(0.0f, -1.0f, 0.0)));   //4
	...
	Indices.push_back(3); Indices.push_back(4); Indices.push_back(1);
